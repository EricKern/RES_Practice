...
// g++ --std=c++11 -o ftdi_write_test ftdi_write_test.cpp -lftdi1 -I /usr/include/libftdi1
// call like this:
// ./ftdiConsole
...
int main(int argc, char **argv){
    ...
    while (!exitRequested)
    {
        uint8_t *gbuf = (unsigned char*)"0";
        cout << sizeof(gbuf) << endl;
        int g = ftdi_write_data(ftdi, gbuf, sizeof(gbuf));
        usleep(1 * 1000000);
    }
    delete [] buf;
